...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 30 16:27:56 2019
...
def create_image_and_mask(fruktis,MyPicGrafitti):

    # import a clean input to be corrupted with the mask 
    input = mpimg.imread(fruktis)
    ...
    mask  = scipy.float64((mpimg.imread(MyPicgrafitti.png) == 1));
